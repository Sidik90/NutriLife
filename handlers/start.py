...
async def cmd_start(message: Message):
    ...
    try:
        ...
        if member.status in ["member", "administrator", "creator"]:
            await message.answer("👋 Привет! Спасибо, что присоединился к 'НутриЛайф' — каналу, где нутрициология становится доступной и интересной 📚🌍. Мы делимся знаниями о правильном питании 🍏🥕, микронутриентах 🧬, метаболизме ⚖️ и их влиянии на здоровье 💪.",
